...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  mage: {
    ...
    name: 'Hechicera',
    emoji: '🔮',
    desc: 'Una gata negra de sombrero puntiagudo que aprendió magia mirando la luna. Su maná se regenera en combate y alimenta hechizos devastadores.',
    spriteKey: 'cat_mage',
    tint: 0xe6d4ff,
    heroScale: 2.0,
    faceLeft: true,
  ...
  rogue: {
    ...
    name: 'Pícara',
    emoji: '🗡️',
    desc: 'Una gata callejera que camina entre sombras y tejados a cuatro patas. Acumula Combo con cada zarpazo. Críticos altísimos y esquiva.',
    spriteKey: 'cat_rogue',
    tint: 0xbcc8e8,
    heroScale: 2.0,
    faceLeft: true,
