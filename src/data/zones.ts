...
export const ZONES: ZoneDef[] = [
  {
    ...
    enemies: [
      ...
      { id: 'gato_montes', name: 'Gato Montés Embrujado', spriteKey: 'cat', scale: 2.5, tint: 0x77995a, hasRunAnim: true },
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      { id: 'lince_cristal', name: 'Lince de Cristal', spriteKey: 'cat', scale: 2.5, tint: 0x8fe0ff, hasRunAnim: true },
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      { id: 'pantera_magma', name: 'Pantera de Magma', spriteKey: 'cat', scale: 2.6, tint: 0xff6a4d, hasRunAnim: true },
    ],
  ...
  },
  {
    ...
    enemies: [
      ...
      { id: 'gata_espectral', name: 'Gata Espectral de la Corte', spriteKey: 'cat', scale: 2.6, tint: 0xddaaff, hasRunAnim: true },
    ],
    boss: { id: 'wizard_king', name: 'Lince Hechicero', title: 'Amo del Castillo Flotante', spriteKey: 'cat', scale: 4.6, tint: 0x9966dd, hasRunAnim: true },
  ...
  },
  {
    ...
    enemies: [
      ...
      { id: 'felino_vacio', name: 'Felino del Vacío', spriteKey: 'cat', scale: 2.7, tint: 0x7d6bff, hasRunAnim: true },
    ],
