...
- Licencia: CC0 1.0 (dominio público)
- Héroes, monstruos, jefes, armas, pociones, cofres, entorno.

## kenney/ — Tiny Dungeon
- Autor: **Kenney** — https://kenney.nl/assets/tiny-dungeon
- Licencia: CC0 1.0 (ver LICENSE-kenney.txt)
- Íconos de equipo (escudos, espadas, pociones) y decoración.
